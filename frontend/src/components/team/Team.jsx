...
import teamBg from "../../assets/images/team/team_bg.png";
      ...
      <div className="container">
        ...
        <div className="team-subheader">
          <p className="team-intro">
            В этих стенах собрались не простые головорезы, а элита пиратского
            мира — мастера своего дела, за головы которых назначена награда за
            идеальную стрижку, опасную работу бритвой и виртуозную укладку, а
            также за умение поднимать настроение без лишних слов. Рассмотрите
            портреты преступников хорошего вкуса и выберите того, кто поведёт
            ваш корабль к идеальному образу.
          </p>
        </div>

        <div className="team-wall">
          <div
            className="team-wall-background"
          ...
          <div className="team-wall-content">
            <Swiper
          ...
          <div className="team-controls team-controls--bottom">
            <button ref={prevRef} className="control-btn">
              <IoChevronBack />
            </button>
            <button ref={nextRef} className="control-btn">
              <IoChevronForward />
            </button>
          </div>
        </div>
