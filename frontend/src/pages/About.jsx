        ...
        <div className="container">
          <div className="about-hero__grid">
            <div className="about-hero__logo">
              <img src={skullImg} alt="Van Blade Logo" />
            </div>
            ...
            <div className="about-hero__manifesto">
              ...
              <div className="about-hero__text-content">
                <p>
                  Van Blade — это не просто парикмахерская. Это тихая гавань для тех, 
                  кто знает цену своему времени и стилю. Мы собрали лучших мастеров, 
                  которых называем Рейнджерами, Шкиперами и Капитанами, чтобы каждый 
                  визит превращался в ритуал.
                </p>
                <p>
                  Наш штурвал повернут в сторону вечных традиций мужского груминга, 
                  но наши паруса полны ветра современных трендов.
                </p>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="about-atmosphere__slider">
            ...
            <div className="about-atmosphere__content">
              ...
              <p>
                Мы создали место, где каждая деталь интерьера рассказывает историю. 
                Здесь запах дорогого табака и кожи смешивается с гулом профессиональных инструментов. 
              </p>
              <p>
                В Van Blade мы ценим приватность и комфорт. Это не просто стрижка — 
                это время, проведенное в кругу своих.
              </p>
            ...
            <div className="quote-wrapper">
              <div className="gold-frame">
                ...
                <div className="quote-text">
                  <blockquote>
                    Мы не просто стрижем бороды — мы куем характер. 
                    В каждом движении лезвия — верность традициям 
                    и уважение к вашей истории.
                  </blockquote>
                  <cite>— Van Blade</cite>
                </div>
