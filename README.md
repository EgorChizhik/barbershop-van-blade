...
---
# Шаг 6: Загрузка данных и медиафайлов
После успешного запуска backend-сервера необходимо загрузить данные из базы данных (услуги, мастера, галерея) и убедиться, что медиафайлы на месте.

# 6.1 Загрузка данных (fixtures)
Находясь в папке backend с активированным виртуальным окружением, выполните:

python manage.py loaddata fixtures.json

После этого все услуги, категории, мастера и галерея будут загружены в базу данных.

# 6.2 Медиафайлы
Папка backend/media/ уже содержится в репозитории — дополнительных действий не требуется. Django автоматически будет отдавать файлы из этой папки при запуске сервера.

# 6.3 Проверка
После загрузки данных откройте сайт в браузере:
